...
class GetBeerData:
    def get_beer_data(self):
        ...
        full_pages = []
        for i in pages:
            r = requests.get(f'http://api.brewerydb.com/v2/beers?key=211e4ce78639dea9b1b394069eeb5a5e&p={i}')
            data = r.json()['data']
...
class StyleBuilder:
    def run(self):
        styler = requests.get('http://api.brewerydb.com/v2/styles?key=211e4ce78639dea9b1b394069eeb5a5e&p=1')
